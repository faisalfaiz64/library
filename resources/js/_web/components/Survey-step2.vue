    ...
    methods: {
        ...
        nextStep() {
			...
			case !!this.survey.phone:
				...
				// this.$parent.isLoading = false;
				break;
			case /^(009665|9665|\+9665|05|5)/.test(this.survey.phone):
				this.$toast.error('The Mobile number you entered is not valid.');
				// this.$parent.isLoading = false;
				break;
